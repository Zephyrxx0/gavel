    ...
    <>
      ...
      >
        ...
        <div className="flex flex-col sm:flex-row items-start gap-5">
          ...
          <div
            onClick={handleOpenDocument}
            className="group relative w-32 sm:w-36 md:w-40 aspect-[8.5/11] rounded-xl border border-stone-200/90 bg-white shadow-md overflow-hidden shrink-0 cursor-pointer transition-transform duration-200 hover:shadow-lg hover:-translate-y-0.5"

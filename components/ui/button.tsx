...
const buttonVariants = cva(
  'inline-flex items-center justify-center whitespace-nowrap rounded-lg text-sm font-medium ring-offset-background transition-all duration-150 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 active:scale-[0.98]',
  {
    variants: {
      variant: {
        default: 'bg-stone-900 text-white hover:bg-stone-800 font-medium shadow-sm',
        destructive:
          'bg-destructive text-destructive-foreground hover:bg-destructive/90',
        outline:
          'border border-stone-200/90 bg-white hover:bg-stone-50 hover:text-stone-900 text-stone-700 shadow-sm',
        secondary:
          'bg-stone-100 text-stone-800 hover:bg-stone-200/80 border border-stone-200/60',
        ghost: 'hover:bg-stone-100 hover:text-stone-900 text-stone-700',
        link: 'text-stone-900 underline-offset-4 hover:underline',
        gold: 'bg-stone-900 text-white hover:bg-stone-800 font-medium shadow-sm transition-all',
      },
      size: {

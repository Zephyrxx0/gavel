...
export function ChatTriggerButton({
  ...
  return (
    <button
      ...
      className={`fixed bottom-[3.75rem] right-6 z-40 mb-[env(safe-area-inset-bottom)] min-h-[48px] min-w-[48px] px-4 py-2.5 flex items-center justify-center gap-2.5 rounded-full bg-stone-900 hover:bg-stone-800 text-white font-medium shadow-lg border border-stone-700/50 active:scale-95 transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-stone-400 ${className}`}
    >

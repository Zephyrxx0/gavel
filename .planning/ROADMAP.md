...
- [ ] **Phase 1: Foundation, Schemas, & Ingestion Pipeline** - Establish core Next.js app, dark legal design system, Zod schemas, disclaimers, and ephemeral in-memory multi-format file extraction.
...
|-------|----------------|--------|-----------|
| 1. Foundation, Schemas, & Ingestion Pipeline | 0/TBD | Not started | - |
